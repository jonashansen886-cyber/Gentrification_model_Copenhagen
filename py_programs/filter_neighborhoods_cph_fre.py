...
# --- Configuration ---
shapefile_path = r'C:\Users\jonas\Desktop\7_semester\Projekt\Data\GIS_lag\Nabolag_cph_fre_new.shp'
input_folder = 'final_lag'
output_folder = 'final_lag' # Output to the same folder
# --- End Configuration ---

def main():
    """
    Filters all CSV files in input_folder based on cluster IDs from a shapefile,
    saves them to output_folder with '_cph_fre' suffix, and reports on unique IDs removed.
    """
    try:
